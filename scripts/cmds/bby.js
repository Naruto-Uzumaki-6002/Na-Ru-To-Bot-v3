        ...
        if (event.type !== "message_reply" && mahmud.some(word => message.startsWith(word))) {
            ...
            const getBotResponse = async (text, attachments) => {
                ...
                const randomMessage = [
                                ...
                                "naw amr boss k message daw 01973198064",
                                "বলো কি বলবা, সবার সামনে বলবা নাকি?🤭🤏",
                                "বেশি bby Bby করলে leave নিবো কিন্তু 😒😒",
                                "𝙏𝙪𝙢𝙖𝙧 𝙗𝙛 𝙣𝙖𝙞, 𝙩𝙖𝙮 𝙖𝙢𝙠 𝙙𝙖𝙠𝙨𝙤? 😂😂😂",
                                "𝗕𝗯𝘆 𝗕𝗯𝘆 না করে আমার বস মানে, 𝗧𝗮𝗶𝗺 , 𝗧𝗮𝗶𝗺 ও তো করতে পারো 😑?",
                                "আমার সোনার বাংলা, তারপরে লাইন কি? 🙈",
                                "𝗔𝘀𝘀𝗮𝗹𝗮𝗺𝘂𝗹𝗮𝗶𝗸𝘂𝗺 🐤",
                                "আমার বস তোমার সিনিয়র ভাইয়া ওকে 😼, সম্মান দেও 🙁",
                                "এত কাছেও এসো না, বসের প্রেমে পরে যাবো তো 🙈",
                                "𝗛𝗲𝘆 𝗦𝘂𝗻𝗱𝗼𝗿𝗶 বলো 😁",
                                "একটা gf খুঁজে দাও আমার বস কে 😿",
                                "amr boss ar janu lagbe, Apu Tumi ki single aso ?",
                                "আমাকে না দেকে একটু পড়তেও বসতে তো পারো 🥺🥺",
                                "চৌধুরী সাহেব আমার বস গরিব হতে পারে 😾🤭 -কিন্তু বড়লোক না 🥹😫",
                                "আমার বস অন্যের জিনিসের সাথে কথা বলে না__😏",
                                "ভুলে জাও আমার বস কে 😞",
                                "তুমি আমার বস কে প্রেম করাই দাও নি 🥺, পচা তুমি 🥺",
                                "বলো কি করতে পারি তোমার জন্য 😚",
                                "কথা দেও আমার বস কে পটাবা...!! 😌",
                                "আমাকে না দেকে একটু পড়তে বসতেও তো পারো 🥺🥺",
                                "Bolo Baby , তুমি কি আমার বসকে ভালোবাসো? 🙈",
                                "আজকে আমার বসের mন ভালো নেই 🙉",
                                "মেয়েদের প্রতি আমার বসের এক আকাশ পরিমান শরম 🥹🫣",
                                "আমার বস ফ্রি ফেসবুক চালায় কা'রন মেয়েদের মুখ দেখা হারাম 😌"  
                             ];
